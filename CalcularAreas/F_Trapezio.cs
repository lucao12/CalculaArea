...
{
    public partial class F_Trapezio : Form
    {
        public F_Trapezio()
        {
            InitializeComponent();
        ...
        private void txtValorBM_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!Char.IsDigit(e.KeyChar) && e.KeyChar != (char)8)
            {
                e.Handled = true;
        ...
        {
            if (txtValorB.Text != "" || txtValorA.Text != "" || txtValorBM.Text != "")
            {
                valor1 = Convert.ToDecimal(txtValorB.Text);
                valor2 = Convert.ToDecimal(txtValorA.Text);
                valor3 = Convert.ToDecimal(txtValorBM.Text);
                txtValorB.Text = "";
                txtValorA.Text = "";
                txtValorBM.Text = "";
                txtResult.Text = Convert.ToString(((valor1 + valor3) * valor2) / 2);
            }
            else
            {
                txtResult.Text = "";
